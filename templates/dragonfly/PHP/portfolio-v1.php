<?php $title="Dragonfly -  Portfolio with Filter I" ; $description="Portfolio with powerful filter. You can sort items by name, date and etc." ; include( "inc/header.php"); ?>
...
<body>
    ...
    <section class="bg-19 bg-center bg-cover">
        <div class="bg-filter">
            <div class="container section-lg">
                <h1 class="top-title">Portfolio Page</h1>
            </div>
        </div>
    </section>
    ...
    <section class="section-lg bg-grey ">
        <div class="container">
            <h2 class="big-title text-center">Recent Projects</h2>
    ...
    <section class="section-lg">
        <div class="container">
            <h2 class="big-title text-center">Our Work</h2>
            <p class="big-subtitle text-center">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus.</p>
            ...
            <ul class="filter-tabs">
                ...
                <li class="filter" data-filter="photos"><span>Photos</span>
                </li>
            </ul>

            <ul class="row filter-grid" id="Grid">
                <!-- Item 1 -->
                ...
                <li class="col-md-4 col-sm-6 mix devices ">
                    <a href="#" title="View portfolio item">
                        <div class="hover-content ">
                            <img src="assets/img/DeathtoStock_Desk1.jpg" class="img-responsive" alt="Apple Macbook Pro">
                            <div class="top-part hidden-xs">
                                <i class="fa fa-eye"></i>
                            </div>
                            <div class="bottom-part hidden-xs">
                ...
                <!-- Item 8-->
                <li class="col-md-4 col-sm-6 mix photos ">
                    <a href="#" title="View portfolio item">
                        <div class="hover-content ">
                            <img src="assets/img/DeathtoStock_Desk3.jpg" class="img-responsive" alt="portfolio item 8">
                            <div class="top-part hidden-xs">
                                <i class="fa fa-eye"></i>
                            </div>
                            <div class="bottom-part hidden-xs">
                ...
                <li class="col-md-4 col-sm-6 mix photos ">
                    <a href="#" title="View portfolio item">
                        <div class="hover-content ">
                            <img src="assets/img/DeathtoStock_Wired3.jpg" class="img-responsive" alt="Portfolio item 9">
                            <div class="top-part hidden-xs">
                                <i class="fa fa-eye"></i>
                            </div>
                            <div class="bottom-part hidden-xs">
    ...
    <section class="section-lg bg-grey-2">
        <div class="container">
            ...
            <div class="row client-logo">
                ...
                <img alt="logo of client - Nike" src="assets/img/logos/Intel.png">
            </div>
        </div>
    </section>
