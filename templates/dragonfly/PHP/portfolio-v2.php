<?php $title="Dragonfly -  Portfolio with Filter II" ; $description="Portfolio with powerful filter. You can sort items by name, date and etc." ; include( "inc/header.php"); ?>
    ...
    <section class="bg-19 bg-center bg-cover">
        <div class="bg-filter">
            <div class="container section-lg">
                <h1 class="top-title">Portfolio with filter</h1>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <ul class="row filter-grid" id="Grid">
                ...
                <li class="col-md-4 col-sm-6 mix photos ">
                    <a href="#" title="View portfolio item">
                        <div class="hover-content ">
                            <img src="assets/img/DeathtoStock_Wired3.jpg" class="img-responsive" alt="portfolio item 7">
                            <div class="top-part hidden-xs">
                                <i class="fa fa-eye"></i>
                            </div>
                            <div class="bottom-part hidden-xs">
                ...
                <li class="col-md-4 col-sm-6 mix photos ">
                    <a href="#" title="View portfolio item">
                        <div class="hover-content ">
                            <img src="assets/img/DeathtoStock_Desk3.jpg" class="img-responsive" alt="portfolio item">
                            <div class="top-part hidden-xs">
                                <i class="fa fa-eye"></i>
                            </div>
                            <div class="bottom-part hidden-xs">
                ...
                <li class="col-md-4 col-sm-6 mix devices ">
                    <a href="#" title="View portfolio item">
                        <div class="hover-content ">
                            <img src="assets/img/DeathtoStock_Desk1.jpg" class="img-responsive" alt="portfolio item 9">
                            <div class="top-part hidden-xs">
                                <i class="fa fa-eye"></i>
                            </div>
                            <div class="bottom-part hidden-xs">
